...
from OUApp import app, db, dao
from flask_admin import Admin, BaseView, expose, AdminIndexView
from flask_admin.contrib.sqla import ModelView
from OUApp.models import User, UserRole, RoomType, Room
...
admin = Admin(app=app, name="Open United Administration", template_mode="bootstrap4", index_view=MyAdminIndex())

admin.add_view(RuleView(name='Rule'))
admin.add_view(RoomTypeView(RoomType, db.session))
admin.add_view(RoomView(Room, db.session))
admin.add_view(StaffView(User, db.session, name='Staff'))
