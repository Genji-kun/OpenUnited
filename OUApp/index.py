from OUApp import app, dao, admin, utils, send_mail, login, controllers
...
app.add_url_rule('/rule-change', 'change_rule', controllers.change_rule, methods=["POST"])
...
app.add_url_rule('/api/booking/rooms/<room_index>/choose', 'staff_choose_room', controllers.staff_choose_room,
                 methods=["POST"])
app.add_url_rule('/api/booking/rooms/<room_index>', 'staff_del_room', controllers.staff_del_room,
                 methods=["DELETE"])
...
app.add_url_rule('/staff/rent/reservations', 'reservations_to_rent', controllers.reservations_to_rent, methods=["GET"])
app.add_url_rule('/api/reservations/<reservation_id>', 'change_reservation', controllers.change_reservation,
                 methods=['PUT'])
app.add_url_rule('/staff/pay', 'pay', controllers.pay, methods=["GET"])
app.add_url_rule('/api/reservations/pay/<reservation_id>', 'pay_reservation', controllers.pay_reservation,
                 methods=['PUT'])
